/**
 * Manages the client/server communication. Handles application json api responses and
 * pjax requests.
 */
application.module('client', function (module, require, $) {
    ...
    var ajax = function (url, cfg, originalEvent) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            var success = function (data, textStatus, xhr) {
                ...
                if (response.type) {
                    event.trigger('application:modules:client:response:' + response.type);
                }
