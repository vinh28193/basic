/**
 * Thid module can be used by applicatio sub modules for registering handlers and serves as core module for executing actions triggered in the gui.
 * A module can either register global handler by using the registerHandler functions or use the component mechanism.
 */
application.module('action', function(module, require, $) {
    var _handler = {};
    var object = require('util').object;
    var string = require('util').string;
    var modal = require('modal', true);
    ...
    Component.component = 'application-component';
     ...
     *
     * @param {type} cfg
     * @returns {application_action_L5.ActionBinding}
     */
    var ActionBinding = function(options) {
        ...
        // namespaced event e.g. click.application-action
     ...
     *
     *  Note: When using application.modules.client for submitting a form or sending a request and providing the action event, the event.finish will be
    ...
    ActionBinding.prototype.handle = function(options) {
        ...
        try {
            ...
            // As last resort we try to call the action by namespace for handlers like application.modules.myModule.myAction
     ...
     *
     * @see {@link application.modules.content.handleAction}
    ...
    var bindAction = function(parent, type, selector, directHandler) {
        ...
        var actionEvent = type + '.application-action';
