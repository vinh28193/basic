 ...
 * @param {type} param2
 */
application.module('modal', function (module, require, $) {
     ...
     * @returns {application.ui.modal_L18.Modal.prototype@call;getContent@call;find}
     */
     ...
     * @returns {application.ui.modal_L18.Modal.prototype@pro;$modal@call;find}
     */
    ...
    var _setGlobalModalTargetHandler = function () {
        ...
        $("a[data-target='#globalModal']").off('.application:globalModal');

        // deprecated use action handler instead @see get action
        $(document).off('click.application:globalModal').on('click.application:globalModal', "a[data-target='#globalModal']", function (evt) {
            evt.preventDefault();
